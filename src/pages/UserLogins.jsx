    ...
    return (
        <div className="min-h-screen bg-background p-6">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div>
                        <h1 className="text-3xl font-bold text-foreground mb-2">Login Tracking</h1>
                        <p className="text-muted-foreground">Monitor all user login activities</p>
                    </div>
                ...
                >
                    <div className="bg-gradient-to-br from-cyan-600/20 to-primary/10 rounded-2xl p-6 border border-cyan-500/30">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-muted-foreground text-sm mb-1">Total Logins</p>
                    ...
                    <div className="bg-gradient-to-br from-violet-600/20 to-violet-500/10 rounded-2xl p-6 border border-violet-500/30">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-muted-foreground text-sm mb-1">Unique Students</p>
                                <p className="text-3xl font-bold text-secondary">
                                    {new Set(logs.map(l => l.roll_number)).size}
                                </p>
                            </div>
                            <Clock className="w-10 h-10 text-secondary opacity-50" />
                        </div>
                    </div>
                    <div className="bg-gradient-to-br from-pink-600/20 to-pink-500/10 rounded-2xl p-6 border border-pink-500/30">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-muted-foreground text-sm mb-1">Today's Logins</p>
